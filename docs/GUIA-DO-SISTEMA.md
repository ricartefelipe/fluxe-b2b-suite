...
| **Feature Flags** | Flags por tenant: nome, habilitada, descrição. Criar, toggle, editar, remover. | Selecione um tenant no header. Ative/desative funcionalidades por tenant. |
