...
export const EN_US_MESSAGES: Messages = {
  ...
  auth: {
    ...
    loginSubtitleDev: 'Sign in with the administrator email and password',
  ...
  payments: {
    ...
    confirmPaymentMessage: 'Do you want to confirm this payment? This action cannot be undone.',
  },
  ledger: {
    entries: 'Entries',
    balances: 'Balances',
  ...
  reports: {
    title: 'Reports',
    subtitle: 'Track orders, payments, and ledger entries with filters and CSV export.',
    ordersTab: 'Orders',
    ...
    ordersHint: 'Operational order report by customer, status, and period.',
    paymentsHint: 'Financial payment report by customer, status, and period.',
    ledgerHint: 'Accounting ledger report by period and currency.',
  },
  checkout: {
    cart: 'Cart',
    shipping: 'Shipping',
  ...
  billing: {
    ...
    invoicesSubtitle: 'Read-only charge history for the subscription.',
    invoicesLoadError: 'Could not load invoices right now.',
    noInvoices: 'No invoices are available for this subscription.',
    invoiceOpen: 'Open',
    invoicePaid: 'Paid',
    invoiceOpenStatus: 'Open',
    invoiceVoid: 'Void',
    invoiceDraft: 'Draft',
    confirmCancelTitle: 'Schedule cancellation?',
  ...
  admin: {
    ...
    confirmDeleteFlagTitle: 'Remove flag?',
    confirmDeleteFlagMessage: 'Are you sure you want to remove this feature flag? This action cannot be undone.',
