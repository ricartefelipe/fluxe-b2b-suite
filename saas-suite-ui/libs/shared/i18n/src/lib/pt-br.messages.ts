...
export const PT_BR_MESSAGES: Messages = {
  ...
  reports: {
    title: 'Relatórios',
    subtitle: 'Acompanhe pedidos, pagamentos e lançamentos com filtros e exportação CSV.',
    ordersTab: 'Pedidos',
    ...
    ordersHint: 'Relatório operacional de pedidos por cliente, status e período.',
    paymentsHint: 'Relatório financeiro de pagamentos por cliente, status e período.',
    ledgerHint: 'Relatório contábil de lançamentos por período e moeda.',
  },
  checkout: {
    cart: 'Carrinho',
    shipping: 'Entrega',
  ...
  billing: {
    ...
    invoicesSubtitle: 'Histórico read-only de cobranças da assinatura.',
    invoicesLoadError: 'Não foi possível carregar as faturas agora.',
    noInvoices: 'Nenhuma fatura disponível para esta assinatura.',
    invoiceOpen: 'Abrir',
    invoicePaid: 'Paga',
    invoiceOpenStatus: 'Aberta',
    invoiceVoid: 'Anulada',
  ...
  usage: {
    ...
    users: 'Usuários',
    nearLimit: 'Perto do limite de usuários do plano.',
    limitReached: 'Limite atingido para usuários do plano.',
  },
  status: {
